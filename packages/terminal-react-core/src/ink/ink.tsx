...
export default class Ink {
  ...
  constructor(private readonly options: Options) {
    ...
    // @ts-ignore createContainer arity differs between published types and runtime
  ...
  pause(): void {
    ...
    // @ts-ignore flushSyncFromReconciler exists at runtime but is missing from types
  ...
  render(node: ReactNode): void {
    ...
    // @ts-ignore updateContainerSync exists at runtime but is missing from types
    reconciler.updateContainerSync(tree, this.container, null, noop);
    // @ts-ignore flushSyncWork exists at runtime but is missing from types
